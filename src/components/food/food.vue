      ...
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="cartcontrol-wrapper">
            <cartcontrol :food="food" @add="addMoreFood"></cartcontrol>
          </div>
          <!--加动画的原因就为了获取位置-->
        ...
        <div class="rating">
          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-for="rating in food.ratings" :key="rating.id" class="rating-item border-1px"
  ...
  export default {
    ...
    methods: {
      ...
      addFirst(event) {
        ...
        // 父亲组件是food 孙子组件是cartcontrol 父亲组件所包含的子组件属性有@add属性所对应的方法
        this.$emit('add', event.target);
        Vue.set(this.food, 'count', 1);
      },
      addMoreFood(target) {
        // 子组件调用父组件的@add方法，即调用爷爷goods组件中的@add方法
